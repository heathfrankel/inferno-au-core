  ...
  class Generator
    class MustSupportMetadataExtractorUsCore4
      ...
      def au_core_3_extractor
        @au_core_3_extractor ||= MustSupportMetadataExtractorUsCore3.new(profile, must_supports)
      end
      ...
      def add_patient_uscdi_elements
        ...
        must_supports[:extensions] << {
          ...
          url: 'http://hl7.org/fhir/us/core/StructureDefinition/au-core-race',
          uscdi_only: true
        }
        must_supports[:extensions] << {
          id: 'Patient.extension:ethnicity',
          url: 'http://hl7.org/fhir/us/core/StructureDefinition/au-core-ethnicity',
          uscdi_only: true
        }
        must_supports[:extensions] << {
          id: 'Patient.extension:birthsex',
          url: 'http://hl7.org/fhir/us/core/StructureDefinition/au-core-birthsex',
          uscdi_only: true
        }
        must_supports[:elements] << {
          path: 'name.suffix',
