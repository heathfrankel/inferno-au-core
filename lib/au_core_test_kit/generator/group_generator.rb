    ...
    class GroupGenerator
      ...
      def search_validation_resource_type
        ...
        if resource_type == 'Condition' && group_metadata.reformatted_version == 'v501'
          case profile_url
          when 'http://hl7.org/fhir/us/core/StructureDefinition/au-core-condition-encounter-diagnosis'
            text.concat(' with category `encounter-diagnosis`')
          when 'http://hl7.org/fhir/us/core/StructureDefinition/au-core-condition-problems-health-concerns'
      ...
      def optional?
        ...
        profile_url == 'http://hl7.org/fhir/us/core/StructureDefinition/au-core-simple-observation'
      end
