  ...
  class Generator
    class MustSupportMetadataExtractorUsCore6
      ...
      def au_core_5_extractor
        @au_core_5_extractor ||= MustSupportMetadataExtractorUsCore5.new(profile, must_supports)
      end
      ...
      def add_must_support_choices
        ...
        if profile.id == 'au-core-observation-screening-assessment'
          more_choices << {
            target_profiles: [
              'http://hl7.org/fhir/us/core/StructureDefinition/au-core-observation-screening-assessment',
              'http://hl7.org/fhir/us/core/StructureDefinition/au-core-questionnaireresponse'
            ]
          }
        end
